 ...
 *  - Base (`erc20Abi`, `erc721Abi`, `erc1155Abi`) — the canonical EIP
 *    specification surface only.  Safe to use against any compliant token.
 *  - Extended (`erc20ExtendedAbi`, `erc721ExtendedAbi`) — base plus the
 *    OpenZeppelin 5.x extension functions (mint, burn, pause, permit, etc.)
 *    These match the interface of ERC20Base and ERC721Base from
 *    `@cfxdevkit/contracts`.
 *
 * All ABIs are `as const` for full TypeScript inference with viem.
 */

// ─── ERC-2612 (Permit / EIP-712 approval) ────────────────────────────────────
...
export const ERC2612_ABI = erc2612Abi;
...
export const erc20ExtendedAbi = [
  ...erc20Abi,
  // ERC20Capped
  { type: 'function', name: 'cap', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  // ERC20Burnable
  {
    type: 'function', name: 'burn',
    inputs: [{ name: 'amount', type: 'uint256' }], outputs: [], stateMutability: 'nonpayable',
  },
  {
    type: 'function', name: 'burnFrom',
  ...
  },
  {
    ...
    inputs: [{ name: 'role', type: 'bytes32' }, { name: 'callerConfirmation', type: 'address' }],
    outputs: [], stateMutability: 'nonpayable',
  },
  {
  ...
  // MINTER_ROLE / PAUSER_ROLE constants
...
export const ERC20_EXTENDED_ABI = erc20ExtendedAbi;

// ─── ERC-721 — base EIP-721 ───────────────────────────────────────────────────
...
export const erc721Abi = [
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'tokenId', type: 'uint256' }, { name: '_data', type: 'bytes' },
    ],
    outputs: [], stateMutability: 'nonpayable',
  },
  {
...
/**
 * ERC-721 extended ABI — base EIP-721 + OZ 5.x extensions:
 * ERC721Enumerable, ERC721Burnable, ERC721Pausable, ERC2981 royalties,
 * AccessControl.  Matches the interface of `ERC721Base`.
 */
export const erc721ExtendedAbi = [
  ...erc721Abi,
  // ERC721Enumerable
  { type: 'function', name: 'totalSupply', inputs: [], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view' },
  {
    type: 'function', name: 'tokenByIndex',
    inputs: [{ name: 'index', type: 'uint256' }], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view',
  },
  {
  ...
  {
    type: 'function', name: 'burn',
    inputs: [{ name: 'tokenId', type: 'uint256' }], outputs: [], stateMutability: 'nonpayable',
  },
  // ERC721Pausable
  { type: 'function', name: 'paused',  inputs: [], outputs: [{ name: '', type: 'bool' }], stateMutability: 'view' },
  { type: 'function', name: 'pause',   inputs: [], outputs: [], stateMutability: 'nonpayable' },
  ...
  {
    type: 'function', name: 'setDefaultRoyalty',
    inputs: [{ name: 'receiver', type: 'address' }, { name: 'feeNumerator', type: 'uint96' }],
    outputs: [], stateMutability: 'nonpayable',
  },
  // AccessControl (same as erc20ExtendedAbi)
  {
    type: 'function', name: 'hasRole',
    inputs: [{ name: 'role', type: 'bytes32' }, { name: 'account', type: 'address' }],
    outputs: [{ name: '', type: 'bool' }], stateMutability: 'view',
...
export const ERC721_EXTENDED_ABI = erc721ExtendedAbi;
...
export const erc1155Abi = [
  // Read
  {
    ...
    inputs: [{ name: 'id', type: 'uint256' }], outputs: [{ name: '', type: 'string' }], stateMutability: 'view',
  },
  {
    type: 'function', name: 'balanceOf',
  ...
  },
  {
    ...
    inputs: [
      { name: 'from', type: 'address' }, { name: 'to', type: 'address' },
      { name: 'ids', type: 'uint256[]' }, { name: 'amounts', type: 'uint256[]' }, { name: 'data', type: 'bytes' },
    ],
    outputs: [], stateMutability: 'nonpayable',
  },
  // Events
  ...
  {
    type: 'event', name: 'URI', anonymous: false,
    inputs: [
...
export const erc4626Abi = [
  ...
  // Conversion
  {
    ...
    inputs:  [{ name: 'assets', type: 'uint256' }], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view',
  },
  {
    type: 'function', name: 'convertToAssets',
    inputs:  [{ name: 'shares', type: 'uint256' }], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view',
  },
  // Limits
  {
    type: 'function', name: 'maxDeposit',
    inputs: [{ name: 'receiver', type: 'address' }], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view',
  },
  {
    type: 'function', name: 'maxMint',
    inputs: [{ name: 'receiver', type: 'address' }], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view',
  },
  {
    type: 'function', name: 'maxWithdraw',
    inputs: [{ name: 'owner', type: 'address' }], outputs: [{ name: '', type: 'uint256' }], stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    outputs: [{ name: 'assets', type: 'uint256' }], stateMutability: 'nonpayable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'shares', type: 'uint256' }, { name: 'receiver', type: 'address' }, { name: 'owner', type: 'address' },
    ],
    outputs: [{ name: 'assets', type: 'uint256' }], stateMutability: 'nonpayable',
  },
  // Events
...
export const ERC4626_ABI = erc4626Abi;
