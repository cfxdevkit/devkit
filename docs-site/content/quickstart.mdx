---
title: Quick Start
description: Get up and running with cfxdevkit in five minutes.
---
...
- Lets you compile and deploy Solidity, browse accounts and run the Bootstrap catalog
...
- [Packages reference](/packages) — per-package API docs  
- [Live Playground](/examples) — run code against testnet in your browser  
- [Devkit CLI](/devkit) — deep dive into the local development environment
