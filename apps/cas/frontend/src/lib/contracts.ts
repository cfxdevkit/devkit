 ...
 *   devtools/contracts/artifacts/contracts/AutomationManager.sol/AutomationManager.json
 *
 * Only the fragments needed by the frontend are included:
 *   - createLimitOrder, createDCAJob, cancelJob
 *   - JobCreated, JobCancelled events
 */
